...
using LIMS.Infrastructure.Services.Printing;
...
namespace LIMS.WebApp.Helpers
{
    public class DocPrinter:Controller
    {
        ...
        public DocPrinter(LIMSCoreDbContext ctx, IHostEnvironment hostingEnvironment)
        {
            _context = ctx;
        ...
        public FileResult CreatePdf(string parcelnum)
        {
            ...
            var strAttachment = Path.Combine(_hostingEnvironment.ContentRootPath, "~/Downloads/" + strPDFFileName);
            var path = Path.Combine(_hostingEnvironment.ContentRootPath, "images/logos/kenyalogo.png");
            var footer = Path.Combine(_hostingEnvironment.ContentRootPath, "images/logos/oakarlogo.png");
